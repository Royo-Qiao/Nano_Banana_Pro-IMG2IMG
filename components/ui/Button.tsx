...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-yellow-400 text-slate-900 hover:bg-yellow-300 shadow-lg shadow-yellow-400/20 active:scale-95",
    secondary: "bg-slate-800 text-white hover:bg-slate-700 border border-slate-700 active:scale-95",
